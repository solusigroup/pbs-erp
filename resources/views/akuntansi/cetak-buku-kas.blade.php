...
<head>
    ...
    <title>Cetak Rekening Kas & Bank - {{ $akun->kode_akun }} - {{ $akun->nama_akun }} - {{ $perusahaan->nama_perusahaan ?? 'PT PINASTIKA BHAKTI SEMESTA' }}</title>
    ...
    <div class="screen-container">
        ...
        <div class="toolbar no-print">
            <div class="toolbar-left">
                <a href="{{ route('akuntansi.buku-kas', request()->query()) }}" class="btn-back">
                    &larr; Kembali ke Buku Kas
                </a>
                <div class="toolbar-info">
                    Rekening: <strong>{{ $akun->kode_akun }} - {{ $akun->nama_akun }}</strong> &bull; Total: <strong>{{ count($mutasiDetails) }} transaksi</strong>
                </div>
            </div>
            <div>
        ...
        <div class="paper">
            ...
            <div class="kop-header">
                <div class="kop-left">
                    ...
                    <div>
                        ...
                        <div class="kop-sub">Buku Rekening Kas &amp; Bank &bull; Pengelolaan Keuangan &amp; Akuntansi</div>
                ...
                <div style="text-align:right">
                    <div class="kop-badge">REKENING KORAN</div>
            ...
            <div class="doc-title-block">
                <div class="doc-title">BUKU MUTASI KAS &amp; BANK (REKENING KORAN)</div>
                <div class="doc-account">{{ $akun->kode_akun }} - {{ $akun->nama_akun }}</div>
            ...
            <div class="kpi-grid">
                ...
                <div class="kpi-box">
                    <span class="kpi-label">Penerimaan (Masuk/Dr)</span>
                    <span class="kpi-value" style="color:#059669">Rp {{ number_format($totalMasuk, 0, ',', '.') }}</span>
                </div>
                <div class="kpi-box">
                    <span class="kpi-label">Pengeluaran (Keluar/Cr)</span>
                    <span class="kpi-value" style="color:#dc2626">Rp {{ number_format($totalKeluar, 0, ',', '.') }}</span>
                </div>
                <div class="kpi-box" style="border-color:#059669; background-color:#ecfdf5">
                    <span class="kpi-label" style="color:#047857">Saldo Akhir</span>
                    <span class="kpi-value" style="color:#047857">Rp {{ number_format($saldoAkhirPeriode, 0, ',', '.') }}</span>
                </div>
            </div>
            ...
            <table class="ledger-table">
                <colgroup>
                    ...
                    <col style="width: 14%;"> <!-- No Bukti -->
                    <col style="width: 8%;">  <!-- Tipe -->
                    <col style="width: 30%;"> <!-- Uraian -->
                    <col style="width: 14%;"> <!-- Lawan Akun -->
                    <col style="width: 8%;">  <!-- Masuk -->
                    <col style="width: 8%;">  <!-- Keluar -->
                    <col style="width: 8%;">  <!-- Saldo -->
                </colgroup>
                <thead>
                    <tr>
                        ...
                        <th>Lawan Akun</th>
                        <th class="text-right">Masuk (Dr)</th>
                        <th class="text-right">Keluar (Cr)</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center" style="padding:16px; color:#64748b; font-style:italic">
                                Tidak ada mutasi transaksi pada rekening ini untuk periode yang dipilih.
                            </td>
                        </tr>
                    @endforelse
                    ...
                    <!-- Grand Total Row -->
                    <tr class="row-total">
                        <td colspan="5" class="text-right" style="text-transform:uppercase">TOTAL MUTASI &amp; SALDO AKHIR:</td>
                        <td class="text-right font-mono" style="color:#047857">{{ number_format($totalMasuk, 0, ',', '.') }}</td>
                        <td class="text-right font-mono" style="color:#b91c1c">{{ number_format($totalKeluar, 0, ',', '.') }}</td>
            ...
            <div class="signature-section">
                ...
                <div class="signature-grid">
                    <div class="signature-box">
                        ...
                        <span class="signature-name">Kasir / Staff Keuangan</span>
            ...
            <div class="doc-footer">
                Rekening Koran Kas &amp; Bank PT Pinastika Bhakti Semesta &bull; Sistem ERP Terpadu PBS-ERP &bull; Standar Akuntansi Keuangan SAK EP / EMKM
            </div>
        </div>
    </div>
